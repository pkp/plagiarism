(function(vue) {
      ...
      return (_ctx, _cache) => {
        ...
        return vue.openBlock(), vue.createBlock(_component_PkpTableCell, null, {
          default: vue.withCtx(() => {
            var _a, _b, _c;
            return [
              ((_a = fileStatus.value) == null ? void 0 : _a.ithenticateSimilarityResult) ? (vue.openBlock(), vue.createElementBlock("span", _hoisted_1$1, [
              ...
              ])) : ((_b = fileStatus.value) == null ? void 0 : _b.ithenticateId) ? (vue.openBlock(), vue.createElementBlock("span", _hoisted_4$1, [
  ...
  const ithenticateSimilarityScoreCell = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["__scopeId", "data-v-9d5bd55e"]]);
  const _hoisted_1 = ["aria-label"];
  const _hoisted_2 = {
    key: 0,
    class: "ithenticate-error-toasts__file"
  };
  const _hoisted_3 = { class: "ithenticate-error-toasts__message" };
  const _hoisted_4 = {
    key: 1,
    class: "ithenticate-error-toasts__guidance"
  };
  const _sfc_main = {
    __name: "IthenticateWorkflowErrorToasts",
    props: {
      fileStageNamespace: { type: String, required: false }
    },
    setup(__props) {
      ...
      const props = __props;
      const { t } = useLocalize2();
      const { isOPS } = useApp2();
      const fileStore = isOPS() ? pkp.registry.getPiniaStore("galleyManager") : pkp.registry.getPiniaStore(props.fileStageNamespace);
      const dismissedIds = vue.ref(/* @__PURE__ */ new Set());
      const errors = vue.computed(() => {
        var _a, _b;
        const list = ((_b = (_a = fileStore == null ? void 0 : fileStore.ithenticateStatus) == null ? void 0 : _a.submission) == null ? void 0 : _b.ithenticateProcessingErrors) ?? [];
        return list.filter((error) => !dismissedIds.value.has(error.id));
      });
      const submissionId = vue.computed(() => {
        var _a, _b, _c;
        const workflowStore = pkp.registry.getPiniaStore("workflow");
        return ((_a = workflowStore == null ? void 0 : workflowStore.submission) == null ? void 0 : _a.id) ?? ((_c = (_b = fileStore == null ? void 0 : fileStore.props) == null ? void 0 : _b.submission) == null ? void 0 : _c.id);
      });
      ...
      return (_ctx, _cache) => {
        const _component_PkpNotification = vue.resolveComponent("PkpNotification");
        return errors.value.length ? (vue.openBlock(), vue.createElementBlock("div", {
          key: 0,
          class: "ithenticate-error-toasts",
          role: "region",
          "aria-live": "polite",
          "aria-label": vue.unref(t)("plugins.generic.plagiarism.workflow.errorToasts.region")
        }, [
          (vue.openBlock(true), vue.createElementBlock(vue.Fragment, null, vue.renderList(errors.value, (error) => {
            return vue.openBlock(), vue.createBlock(_component_PkpNotification, {
              key: error.id,
              type: "warning",
              "can-dismiss": true,
              class: "ithenticate-error-toasts__item",
              onDismiss: ($event) => dismiss(error.id)
            }, {
              default: vue.withCtx(() => [
                error.fileName ? (vue.openBlock(), vue.createElementBlock("span", _hoisted_2, vue.toDisplayString(error.fileName), 1)) : vue.createCommentVNode("", true),
                vue.createElementVNode("span", _hoisted_3, vue.toDisplayString(error.message), 1),
                error.guidance ? (vue.openBlock(), vue.createElementBlock("span", _hoisted_4, vue.toDisplayString(error.guidance), 1)) : vue.createCommentVNode("", true)
              ]),
              _: 2
            }, 1032, ["onDismiss"]);
          }), 128))
  ...
  const IthenticateWorkflowErrorToasts = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-48a945f4"]]);
  ...
  function runPlagiarismAction(piniaContext, stageNamespace) {
    ...
    function isEulaConfirmationRequired(contextStatus, submissionStatus, userStatus) {
      ...
      if (userStatus.ithenticateEulaVersion !== contextStatus.eulaVersion || submissionStatus.ithenticateEulaVersion !== contextStatus.eulaVersion || submissionStatus.ithenticateEulaVersion !== userStatus.ithenticateEulaVersion) {
        return true;
      }
      return false;
    }
